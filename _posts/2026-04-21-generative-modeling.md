...
This post first presents the foundations of *score-based diffusion models* and *flow matching* in the context of generative modeling, emphasizing the underlying transport processes that map data from $$p_0$$ to $$p_1$$ and their approximation using neural networks.
